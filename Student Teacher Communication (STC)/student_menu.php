...
<div class="center">
  <p class="thick" style="color:White;">STUDENT</p>
<div class="container">
...
<label class="form-check-label" for="subject">Subject</label>
  ...
  <a href="s_uploadfile.php" class="btn btn-success btn-lg" role="button">Upload Document</a>
  </div>
  <br>
  <br>
            ...
            <table class="table table-striped table-dark">
                <thead>
                    <tr>
                        ...
                        <th><p class="thick" style="color:White;">Upload Time</p></th>
                ...
                if(isset($_POST['sub_btn']))
                {
                    ...
                    $sql = "select fname,file,u_time from $menu where stream='$stream' AND semester='$semester' AND subject='$subject'";
                    ...
                    <tr>
                        ...
                        <td><p class="thick" style="color:White;"><?php echo $row['file']; ?></p></td>
                        <td><p class="thick" style="color:White;"><?php echo $row['u_time']; ?></p></td>
                        <td><a href="files/<?php echo $row['file']; ?>" target="_blank">View</a></td>
                        <td><a href="files/<?php echo $row['file']; ?>" download>Download</td>
                    </tr>
                    <?php } ?>
                <?php } ?>
                </tbody>
